...
CREATE TABLE "public"."Room" (
    ...
    "capaticy" INTEGER NOT NULL DEFAULT 1,
...
-- AddForeignKey
ALTER TABLE "public"."RoomAmenities" ADD CONSTRAINT "RoomAmenities_amenitiedId_fkey" FOREIGN KEY ("amenitiedId") REFERENCES "public"."Amenities"("id") ON DELETE CASCADE ON UPDATE CASCADE;
