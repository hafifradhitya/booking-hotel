            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <p className="text-gray-700 py-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                        Impedit odio reprehenderit consectetur quos voluptas pariatur provident a quo non ipsum!
                    </p>
                        ...
                        <li className="flex gap-5">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-600">Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
                                    Obcaecati impedit tempore reiciendis ab, sed quia!
                                </p>
                            </div>
                        </li>
                        <li className="flex gap-5">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                                    Deleniti, illo. At aspernatur ipsam minima dolorem aliquid facere molestias iusto ex?
                                </p>
                            </div>
                        </li>
                    </ul>
